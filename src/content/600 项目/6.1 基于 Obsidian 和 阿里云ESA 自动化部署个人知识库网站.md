---
title: Obsidian + Quartz + 阿里云 ESA 的个人知识发布系统          # 不填则自动取正文第一个 # 标题
date: 2026-03-5         # 用于 Timeline 排序
description:  GitHub Actions 自动化技术部署到阿里云 ESA 的边缘节点  # 用于卡片摘要
tags: [esa, thoughts,阿里云,obsidian]     # 用于标签和 Thoughts 筛选
---
# 项目简介
